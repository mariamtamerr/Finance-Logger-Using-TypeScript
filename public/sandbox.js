...
// inputs
const input1 = document.querySelector('#tofrom');
...
form.addEventListener("submit", (e) => {
    e.preventDefault();
    let doc; // variable with data type hasFormatter and in the future will be an object that has hasFormatter as an interface
    if (select.value === "invoice") {
        doc = new Invoice(input1.value, input2.value, input3.valueAsNumber);
    }
    else {
